...
public class Post_addition_test extends BaseTest {
    ...
    public void additionTestPositiveOperands(long val1, long val2) {
        ...
        PostComputeRequest request = new PostComputeRequest().withVal1(val1).withVal2(val2).withOperation(Operation.ADD);
    ...
    public void additionExcessIntTest(long val1, long val2) {
        PostComputeRequest request = new PostComputeRequest().withVal1(val1).withVal2(val2).withOperation(Operation.ADD);
        Response response = RestAssured.given().contentType(ContentType.JSON).body(request).log().all()
                .post(Endpoints.postCompute);
