...
public class Post_subtraction_test extends BaseTest {
    ...
    public void subtractionTestPositiveOperands(long val1, long val2) {
        ...
        PostComputeRequest request = new PostComputeRequest().withVal1(val1).withVal2(val2).withOperation(Operation.SUB);
    ...
    public void subtractionExcessIntTest(long val1, long val2) {
        PostComputeRequest request = new PostComputeRequest().withVal1(val1).withVal2(val2).withOperation(Operation.SUB);
        Response response = RestAssured.given().contentType(ContentType.JSON).body(request).log().all()
                .post(Endpoints.postCompute);
